...
bool px4_msgs__msg__esc_eeprom_write__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._esc_eeprom_write.EscEepromWrite", full_classname_dest, 45) == 0);
  }
  px4_msgs__msg__EscEepromWrite * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // firmware
    ...
    assert(PyLong_Check(field));
    ros_message->firmware = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // index
  ...
  {  // write_mask
    PyObject * field = PyObject_GetAttrString(_pymsg, "write_mask");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 2;
      uint32_t * dest = ros_message->write_mask;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__esc_eeprom_write__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of EscEepromWrite */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._esc_eeprom_write");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EscEepromWrite");
  ...
  px4_msgs__msg__EscEepromWrite * ros_message = (px4_msgs__msg__EscEepromWrite *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // firmware
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->firmware);
    {
  ...
  {  // data
    ...
    memcpy(dst, src, 48 * sizeof(uint8_t));
    Py_DECREF(field);
  }
  {  // write_mask
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "write_mask");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint32_t * src = &(ros_message->write_mask[0]);
