...
bool px4_msgs__msg__vte_aid_source1d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs.msg._vte_aid_source1d.VteAidSource1d", full_classname_dest, 45) == 0);
  }
  px4_msgs__msg__VteAidSource1d * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // time_last_predict
    PyObject * field = PyObject_GetAttrString(_pymsg, "time_last_predict");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->time_last_predict = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // observation
  ...
  {  // fusion_status
    ...
    assert(PyLong_Check(field));
    ros_message->fusion_status = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // time_since_meas_ms
    PyObject * field = PyObject_GetAttrString(_pymsg, "time_since_meas_ms");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->time_since_meas_ms = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // history_steps
    PyObject * field = PyObject_GetAttrString(_pymsg, "history_steps");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->history_steps = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * px4_msgs__msg__vte_aid_source1d__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of VteAidSource1d */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs.msg._vte_aid_source1d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VteAidSource1d");
  ...
  px4_msgs__msg__VteAidSource1d * ros_message = (px4_msgs__msg__VteAidSource1d *)raw_ros_message;
  {  // timestamp
    PyObject * field = NULL;
  ...
  {  // time_last_predict
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->time_last_predict);
    {
      int rc = PyObject_SetAttrString(_pymessage, "time_last_predict", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // fusion_status
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->fusion_status);
    {
  ...
  {  // time_since_meas_ms
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->time_since_meas_ms);
    {
      int rc = PyObject_SetAttrString(_pymessage, "time_since_meas_ms", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // history_steps
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->history_steps);
    {
      int rc = PyObject_SetAttrString(_pymessage, "history_steps", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
